...
{
    public class PropertyTypeService(AppDbContext context, IWebHostEnvironment env, IMapper mapper) : IPropertyType
    {
        ...
        {
            var category = mapper.Map<PropertyType>(dto);
            ...
            context.PropertyTypes.Add(category);
        ...
        {
            var category = await context.PropertyTypes.FindAsync(id); ;
        ...
        public async Task<bool> DeleteAsync(int id)
        {
            ...
            context.PropertyTypes.Remove(category);
            await context.SaveChangesAsync();
            return true;
        }
        ...
        private async Task<string> SaveImageAsync(IFormFile file)
        {
            ...
            string uploadsPath = Path.Combine(env.WebRootPath, "images/property_types");
            ...
            return $"images/property_types/{fileName}";
        }
    }
}
